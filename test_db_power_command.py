#!/usr/bin/env python3
"""
Extract real IR signal data from the database and test power command
"""
            ...
            for query in power_queries:
                ...
                if results:
                    ...
                    for command in results:
                        ...
                        found_commands.extend(results)
                    break
            
            if found_commands:
                # Use the first power command found
                power_command = found_commands[0]
...
def test_db_power_command():
    ...
    print(f"   Data Hex: {db_command['sig_data'].hex()}")
    ...
    try:
        ...
        print(f"\n🔋 Sending REAL power command with HIGH power on Port 9...")
        ...
        try:
            ...
            print(f"   ✅ Real power command sent! (seq: {seq_num})")
...
if __name__ == "__main__":
    print("🎯 DATABASE POWER COMMAND TEST")
    print("=" * 50)
    print("This script will:")
    print("1. Connect to your MySQL database")
    print("2. Find power-related IR commands")
    print("3. Test the real command with your RedRat device")
    print()
